...
const MobileSidebar = ({toggleMenu, position, setPosition}) => {
  return (
    <div className={`w-[270px] md:hidden absolute ${position ? "right-0" : "-right-72"} top-0 z-10 transition-all duration-300 ease-in-out`}>
      <IoClose onClick={() => setPosition(!position)} className="text-[#FFF] absolute right-0 text-3xl m-3 cursor-pointer active:bg-blue-700 active:rounded-full" />
